...
#  define OT_IDLE_DEFINE_FACTORY \
    NS_GENERIC_FACTORY_CONSTRUCTOR(otIdleServiceUnix) NS_DEFINE_NAMED_CID(OT_IDLE_CID);
...
#    include "otIdleWin.h"
#    define OT_IDLE_DEFINE_FACTORY \
      NS_GENERIC_FACTORY_CONSTRUCTOR(otIdleServiceWin) NS_DEFINE_NAMED_CID(OT_IDLE_CID);
