/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM nsIImageLoadingContent1_9_2.idl
 */

#ifndef __gen_nsIImageLoadingContent1_9_2_h__
#define __gen_nsIImageLoadingContent1_9_2_h__


#ifndef __gen_imgIDecoderObserver1_9_2_h__
#include "imgIDecoderObserver1_9_2.h"
#endif
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIImageLoadingContent1_9_2 : public imgIDecoderObserver1_9_2 {
 public: 
   ...
   */
  /* void addObserver (in imgIDecoderObserver1_9_2 aObserver); */
  NS_SCRIPTABLE NS_IMETHOD AddObserver(imgIDecoderObserver1_9_2 *aObserver) = 0;
   ...
   */
  /* void removeObserver (in imgIDecoderObserver1_9_2 aObserver); */
  NS_SCRIPTABLE NS_IMETHOD RemoveObserver(imgIDecoderObserver1_9_2 *aObserver) = 0;
   ...
   * which request got passed through to the imgIDecoderObserver1_9_2
...
#define NS_DECL_NSIIMAGELOADINGCONTENT_1_9_2 \
  ...
  NS_SCRIPTABLE NS_IMETHOD AddObserver(imgIDecoderObserver1_9_2 *aObserver); \
  NS_SCRIPTABLE NS_IMETHOD RemoveObserver(imgIDecoderObserver1_9_2 *aObserver); \
...
#define NS_FORWARD_NSIIMAGELOADINGCONTENT_1_9_2(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD AddObserver(imgIDecoderObserver1_9_2 *aObserver) { return _to AddObserver(aObserver); } \
  NS_SCRIPTABLE NS_IMETHOD RemoveObserver(imgIDecoderObserver1_9_2 *aObserver) { return _to RemoveObserver(aObserver); } \
...
#define NS_FORWARD_SAFE_NSIIMAGELOADINGCONTENT_1_9_2(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD AddObserver(imgIDecoderObserver1_9_2 *aObserver) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddObserver(aObserver); } \
  NS_SCRIPTABLE NS_IMETHOD RemoveObserver(imgIDecoderObserver1_9_2 *aObserver) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveObserver(aObserver); } \
...
/* Header file */
class nsImageLoadingContent : public nsIImageLoadingContent1_9_2
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSIIMAGELOADINGCONTENT_1_9_2
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsImageLoadingContent, nsIImageLoadingContent1_9_2)
...
/* void addObserver (in imgIDecoderObserver1_9_2 aObserver); */
NS_IMETHODIMP nsImageLoadingContent::AddObserver(imgIDecoderObserver1_9_2 *aObserver)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void removeObserver (in imgIDecoderObserver1_9_2 aObserver); */
NS_IMETHODIMP nsImageLoadingContent::RemoveObserver(imgIDecoderObserver1_9_2 *aObserver)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
#endif /* __gen_nsIImageLoadingContent1_9_2_h__ */
