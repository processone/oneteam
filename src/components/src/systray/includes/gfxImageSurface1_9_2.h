...
#ifndef GFX_IMAGESURFACE1_9_2_H
#define GFX_IMAGESURFACE1_9_2_H
 ...
 */
class THEBES_API gfxImageSurface1_9_2 : public gfxASurface1_9_2 {
public:
    /**
     ...
     * @see gfxImageFormat
     */
    gfxImageSurface1_9_2(unsigned char *aData, const gfxIntSize& aSize,
     ...
     * @see gfxImageFormat
     */
    gfxImageSurface1_9_2(const gfxIntSize& size, gfxImageFormat format);
    gfxImageSurface1_9_2(cairo_surface_t *csurf);

    virtual ~gfxImageSurface1_9_2();
