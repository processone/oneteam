/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/prefiks/src/mozilla/trunk/mozilla/gfx/idl/gfxtypes1_9.idl
 */

#ifndef __gen_gfxtypes1_9_h__
#define __gen_gfxtypes1_9_h__
