...
#ifndef GFX_ASURFACE1_9_2_H
#define GFX_ASURFACE1_9_2_H
...
class gfxImageSurface1_9_2;

/**
 * A surface is something you can draw on. Instantiate a subclass of this
 * abstract class, and use gfxContext to draw on this surface.
 */
class THEBES_API gfxASurface1_9_2 {
public:
...
protected:
    gfxASurface1_9_2() : mSurface(nsnull), mFloatingRefs(0), mSurfaceValid(PR_FALSE) { }
