/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/prefiks/src/mozilla/trunk/mozilla/content/base/public/nsIImageLoadingContent1_9.idl
 */

#ifndef __gen_nsIImageLoadingContent1_9_h__
#define __gen_nsIImageLoadingContent1_9_h__
...
#define NS_NO_VTABLE
#endif
class imgIRequest1_9; /* forward declaration */
...
/* starting interface:    nsIImageLoadingContent1_9 */
#define NS_IIMAGELOADINGCONTENT1_9_IID_STR "7744c6d3-5c60-4b7b-a526-4fe9d5ac7e97"

#define NS_IIMAGELOADINGCONTENT1_9_IID \
 ...
 */
class NS_NO_VTABLE NS_SCRIPTABLE nsIImageLoadingContent1_9 : public imgIDecoderObserver1_9 {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IIMAGELOADINGCONTENT1_9_IID)
   ...
   */
  /* void addObserver (in imgIDecoderObserver1_9 aObserver); */
  NS_SCRIPTABLE NS_IMETHOD AddObserver(imgIDecoderObserver1_9 *aObserver) = 0;
   ...
   */
  /* void removeObserver (in imgIDecoderObserver1_9 aObserver); */
  NS_SCRIPTABLE NS_IMETHOD RemoveObserver(imgIDecoderObserver1_9 *aObserver) = 0;
   ...
   * known
   */
  /* imgIRequest1_9 getRequest (in long aRequestType); */
  NS_SCRIPTABLE NS_IMETHOD GetRequest(PRInt32 aRequestType, imgIRequest1_9 **_retval) = 0;
   ...
   */
  /* long getRequestType (in imgIRequest1_9 aRequest); */
  NS_SCRIPTABLE NS_IMETHOD GetRequestType(imgIRequest1_9 *aRequest, PRInt32 *_retval) = 0;
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIImageLoadingContent1_9, NS_IIMAGELOADINGCONTENT1_9_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIIMAGELOADINGCONTENT1_9 \
  ...
  NS_SCRIPTABLE NS_IMETHOD AddObserver(imgIDecoderObserver1_9 *aObserver); \
  NS_SCRIPTABLE NS_IMETHOD RemoveObserver(imgIDecoderObserver1_9 *aObserver); \
  NS_SCRIPTABLE NS_IMETHOD GetRequest(PRInt32 aRequestType, imgIRequest1_9 **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetRequestType(imgIRequest1_9 *aRequest, PRInt32 *_retval); \
...
#define NS_FORWARD_NSIIMAGELOADINGCONTENT1_9(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD AddObserver(imgIDecoderObserver1_9 *aObserver) { return _to AddObserver(aObserver); } \
  NS_SCRIPTABLE NS_IMETHOD RemoveObserver(imgIDecoderObserver1_9 *aObserver) { return _to RemoveObserver(aObserver); } \
  NS_SCRIPTABLE NS_IMETHOD GetRequest(PRInt32 aRequestType, imgIRequest1_9 **_retval) { return _to GetRequest(aRequestType, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetRequestType(imgIRequest1_9 *aRequest, PRInt32 *_retval) { return _to GetRequestType(aRequest, _retval); } \
...
#define NS_FORWARD_SAFE_NSIIMAGELOADINGCONTENT1_9(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD AddObserver(imgIDecoderObserver1_9 *aObserver) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddObserver(aObserver); } \
  NS_SCRIPTABLE NS_IMETHOD RemoveObserver(imgIDecoderObserver1_9 *aObserver) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveObserver(aObserver); } \
  NS_SCRIPTABLE NS_IMETHOD GetRequest(PRInt32 aRequestType, imgIRequest1_9 **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRequest(aRequestType, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetRequestType(imgIRequest1_9 *aRequest, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRequestType(aRequest, _retval); } \
...
/* Header file */
class nsImageLoadingContent1_9 : public nsIImageLoadingContent1_9
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSIIMAGELOADINGCONTENT1_9

  nsImageLoadingContent1_9();
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsImageLoadingContent1_9, nsIImageLoadingContent1_9)

nsImageLoadingContent1_9::nsImageLoadingContent1_9()
{
...
/* attribute boolean loadingEnabled; */
NS_IMETHODIMP nsImageLoadingContent1_9::GetLoadingEnabled(PRBool *aLoadingEnabled)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsImageLoadingContent1_9::SetLoadingEnabled(PRBool aLoadingEnabled)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* readonly attribute short imageBlockingStatus; */
NS_IMETHODIMP nsImageLoadingContent1_9::GetImageBlockingStatus(PRInt16 *aImageBlockingStatus)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void addObserver (in imgIDecoderObserver1_9 aObserver); */
NS_IMETHODIMP nsImageLoadingContent1_9::AddObserver(imgIDecoderObserver1_9 *aObserver)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void removeObserver (in imgIDecoderObserver1_9 aObserver); */
NS_IMETHODIMP nsImageLoadingContent1_9::RemoveObserver(imgIDecoderObserver1_9 *aObserver)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* imgIRequest1_9 getRequest (in long aRequestType); */
NS_IMETHODIMP nsImageLoadingContent1_9::GetRequest(PRInt32 aRequestType, imgIRequest1_9 **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* long getRequestType (in imgIRequest1_9 aRequest); */
NS_IMETHODIMP nsImageLoadingContent1_9::GetRequestType(imgIRequest1_9 *aRequest, PRInt32 *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* readonly attribute nsIURI currentURI; */
NS_IMETHODIMP nsImageLoadingContent1_9::GetCurrentURI(nsIURI * *aCurrentURI)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIStreamListener loadImageWithChannel (in nsIChannel aChannel); */
NS_IMETHODIMP nsImageLoadingContent1_9::LoadImageWithChannel(nsIChannel *aChannel, nsIStreamListener **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void forceReload (); */
NS_IMETHODIMP nsImageLoadingContent1_9::ForceReload()
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
#endif /* __gen_nsIImageLoadingContent1_9_h__ */
