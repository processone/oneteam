var EXPORTED_SYMBOLS=["NS_DISCO_ITEMS", "NS_DISCO_INFO", "NS_VCARD",
    "NS_AUTH", "NS_AUTH_ERROR", "NS_REGISTER", "NS_SEARCH", "NS_ROSTER",
    "NS_PRIVACY", "NS_PRIVATE", "NS_VERSION", "NS_TIME", "NS_LAST",
    "NS_XDATA", "NS_IQDATA", "NS_DELAY", "NS_EXPIRE", "NS_EVENT",
    "NS_XCONFERENCE", "NS_STATS", "NS_MUC", "NS_MUC_USER",
    "NS_MUC_ADMIN", "NS_MUC_OWNER", "NS_PUBSUB", "NS_PUBSUB_EVENT",
    "NS_PUBSUB_OWNER", "NS_PUBSUB_NMI", "NS_COMMANDS", "NS_STREAM",
    "NS_STANZAS", "NS_STREAMS", "NS_TLS", "NS_SASL", "NS_SESSION",
    "NS_BIND", "NS_FEATURE_IQAUTH", "NS_FEATURE_IQREGISTER",
    "NS_FEATURE_COMPRESS", "NS_COMPRESS", "STANZA_ERROR",
    "ERR_BAD_REQUEST", "ERR_CONFLICT", "ERR_FEATURE_NOT_IMPLEMENTED",
    "ERR_FORBIDDEN", "ERR_GONE", "ERR_INTERNAL_SERVER_ERROR",
    "ERR_ITEM_NOT_FOUND", "ERR_JID_MALFORMED", "ERR_NOT_ACCEPTABLE",
    "ERR_NOT_ALLOWED", "ERR_NOT_AUTHORIZED", "ERR_PAYMENT_REQUIRED",
    "ERR_RECIPIENT_UNAVAILABLE", "ERR_REDIRECT",
    "ERR_REGISTRATION_REQUIRED", "ERR_REMOTE_SERVER_NOT_FOUND",
    "ERR_REMOTE_SERVER_TIMEOUT", "ERR_RESOURCE_CONSTRAINT",
    "ERR_SERVICE_UNAVAILABLE", "ERR_SUBSCRIPTION_REQUIRED",
