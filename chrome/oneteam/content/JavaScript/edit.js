...
function displayEditButton(body, message, xulNode) {
  ...
  function _updateButtons() {
    ...
    function setTooltip(element, enabled, version, timestamp) {
      element.title = enabled ?
        _(    "See version {0} (from {1}), {2}", version, nbVersions, readableTimestamp(timestamp)):
        _("This is version {0} (from {1}), {2}", version, nbVersions, readableTimestamp(timestamp));
    }
  }
