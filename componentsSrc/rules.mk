...
PC_DIR=$(otdir)/..
ABI_PC_DIR=$(PC_DIR)/$(ABI)/platform/$(ABI)
ABI_PC_DIR=$(PC_DIR)
...
libs::
	...
	$(SYSINSTALL) $(IFLAGS1) $(DLL_PREFIX)$(LIBRARY_NAME)$(DLL_SUFFIX) $(ABI_PC_DIR)/components
else
libs::
	$(STRIP) $(DLL_PREFIX)$(LIBRARY_NAME)$(DLL_SUFFIX)
...
override AUTOCONF_TOOLS=$(otdir)/tools/libtoolize.pl --root-dir=$(otdir) --
